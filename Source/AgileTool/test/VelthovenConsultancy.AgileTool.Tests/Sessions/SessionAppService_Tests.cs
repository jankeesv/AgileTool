...
using VelthovenConsultancy.AgileTool.Sessions;
using Shouldly;
using Xunit;

namespace VelthovenConsultancy.AgileTool.Tests.Sessions
{
    public class SessionAppService_Tests : AgileToolTestBase
    {
