...
using VelthovenConsultancy.AgileTool.Web.Authentication;
using VelthovenConsultancy.AgileTool.Web.Models.Account;

namespace VelthovenConsultancy.AgileTool.Web.Controllers
{
    public class AccountController : AgileToolControllerBase
    {
